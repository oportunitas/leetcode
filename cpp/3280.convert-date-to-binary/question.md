# [3280. Convert Date to Binary][link] (Easy)
...
- The input is generated such that `date` represents a valid Gregorian calendar date between Jan 1,
1900 and Dec 31, 2100 (both inclusive).
