# [3668. Restore Finishing Order][link] (Easy)
...
The finishing order is `[3, 1, 2, 5, 4]`. Therefore, the finishing order of your friends is `[3, 1,
4]`.
...
The finishing order is `[1, 4, 5, 3, 2]`. Therefore, the finishing order of your friends is `[5,
2]`.
